...
import 'package:bmi_calculator_app/drawer.dart';
          ...
          child: Column(
            children: [
              ...
              Text(
                bmiResults,
                style:
                    textStyle.copyWith(color: Color(0xffCABFDC), fontSize: 20),
              ),
              Divider(
...
selectGenderButton({Function onPress, Color color}) {
...
chooseRange({icon, Function onTap}) {
  return InkWell(
    ...
    child: Container(
      ...
      decoration:
          BoxDecoration(color: Color(0xff7E689F), shape: BoxShape.circle),
    ),
  );
}
